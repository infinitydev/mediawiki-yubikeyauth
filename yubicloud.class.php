 ...
 * Change Log
 *
 *   2015-02-08 4.3.3.0 infinity_dev Fix UTC issue, add $server_list parameter
 ...
 */
{
    ...
    function Yubicloud($yubicloud_client_id = 1, $yubicloud_secret_key = '', $yubicloud_server_list = null, $yubicloud_https = false)
    /**
